...
COMMENT ON TABLE "public"."order_items" IS 'an order item contains things like how much quantity youre buying of a certain product and its size.';
...
COMMENT ON TABLE "public"."products" IS 'This contains all the product details';
